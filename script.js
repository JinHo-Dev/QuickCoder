...
window.onload = function() {
    if(localStorage.getItem("paper") == null) {
        paper.value = "#include <bits/stdc++.h>\nusing namespace std;\n//gvr\n//gvr\nint main() {\n    ios_base::sync_with_stdio(false);\n    cin.tie(NULL);\n    \n    return 0;\n}";
    }
    ...
    if(event.key == ";" || event.key == ")" || event.key == "]" || event.key == "}") {
        ...
        if(paper.selectionStart == paper.selectionEnd) {
            ...
            if(paper.value.substring(idx-4, idx) == "    ") {
                ...
                event.preventDefault();
                paper.value = "#include <bits/stdc++.h>\nusing namespace std;\n//gvr\n//gvr\nint main() {\n    ios_base::sync_with_stdio(false);\n    cin.tie(NULL);\n    \n    return 0;\n}";
                paper.selectionStart = 132;
                paper.selectionEnd = 132;
                filename.value = '';
...
function colorful() {
    ...
    document.getElementsByClassName("sh_cpp")[0].innerText = paper.value;
...
function paperResize() {
    ...
    paper.style.height = Math.max(cover.clientHeight, document.getElementsByClassName("sh_cpp")[0].clientHeight) + "px";
    paper.style.width = Math.max(cover.clientWidth, document.getElementsByClassName("sh_cpp")[0].clientWidth) + "px";
...
function filePaper() {
    ...
    if(filename.value == "") {
        fileLink.download = "source.cpp";
    }
    else {
        fileLink.download = filename.value + ".cpp";
    }
